...
<head>
  ...
  <link rel="preload" as="style" href="assets/mobirise/css/mbr-additional.css?v=CUO0XZ"><link rel="stylesheet" href="assets/mobirise/css/mbr-additional.css?v=CUO0XZ" type="text/css">
  <style>
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu5 cid-ufYQVgLUHh" once="menu" id="menu05-2r">
...
<section data-bs-version="5.1" class="form5 cid-ufYRkAIqrD" id="form5-2v">
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form">
                <form action="#" method="POST" class="mbr-form form-with-styler" data-verified="" enctype="multipart/form-data">
                    <div class="row">
                    ...
                    <div class="dragArea row">
                        <div class="col-12 form-group mb-3" data-for="name">
                            <input type="text" name="name" placeholder="Name" data-form-field="name" class="form-control" required="" id="name-form5-2v">
                        </div>
                        <div class="col-12 form-group mb-3" data-for="email">
                            <input type="email" name="email" placeholder="E-mail" data-form-field="email" class="form-control" required="" id="email-form5-2v">
                        </div>
                        <!-- <div class="col-12 form-group mb-3" data-for="file"> -->
                        <div class="input-group mb-3">
                           <label class="input-group-text" for="inputGroupFile02">Upload result slip</label>
                            <input type="file" class="form-control" id="inputGroupFile02">
                        </div>
                        <!-- </div> -->
                        <div class="col-12 form-group mb-3" data-for="city">
                            <select name="city" data-form-field="city" class="form-select" required="" id="city-form5-2v">
                                <option value="" disabled="" selected="">Select City</option>
                                <option value="City1">Mbarara</option>
                                <option value="City2">Isingiro</option>
                                <option value="City3">Kabale</option>
                                <option value="City3">Ntungamo</option>
                                <option value="City3">Ibanda</option>
                                <option value="City3">Bushenyi</option>
                                <option value="City3">Kampala</option>
                                <!-- Add more options as needed -->
                            </select>
                        </div>
                        <div class="col-12 form-group mb-3" data-for="parish">
                            <select name="parish" data-form-field="parish" class="form-select" required="" id="parish-form5-2v">
                                <option value="" disabled="" selected="">Select Parish</option>
                                <option value="Parish1">Uganda Martyrs' Parish</option>
                                <option value="Parish2">St. Charles Lwanga Parish</option>
                                <option value="Parish3">Our Lady of The Rosary</option>
                                <option value="Parish3">Holy Family Parish</option>
                                <!-- Add more options as needed -->
                            </select>
                        </div>
                        <div class="col-12 form-group mb-3" data-for="class">
                            <select name="class" data-form-field="class" class="form-select" required="" id="class-form5-2v">
                                <option value="" disabled="" selected="">Select Class to Join</option>
                                <option value="Class1">S1</option>
                                <option value="Class2">S2</option>
                                <option value="Class3">S3</option>
                                <option value="Class3">S5</option>
                                <!-- Add more options as needed -->
                            </select>
                        </div>
...
<section data-bs-version="5.1" class="contacts01 cid-ug2JPZGbHl mbr-parallax-background" id="contacts01-2x">
...
<section data-bs-version="5.1" class="footer3 cid-ufYQViighV" once="footers" id="footer03-2t">
