...
<head>
  ...
  <link rel="preload" as="style" href="assets/mobirise/css/mbr-additional.css?v=iduLxy"><link rel="stylesheet" href="assets/mobirise/css/mbr-additional.css?v=iduLxy" type="text/css">
  <style>
...
$dbname = "jovoccon"; // Replace with your MySQL database name

// Handle form submission
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Validate input (you may want to sanitize and validate further)
    $name = $_POST['name'];
    ...
    // Note: Use prepared statements to prevent SQL injection in production code
...
?>
  ...
  <section data-bs-version="5.1" class="menu menu5 cid-ufL8dWfzKo" once="menu" id="menu05-2h">
...
<section data-bs-version="5.1" class="form5 cid-ufYNupOC7O" id="form02-2j">
    
    <div class="mbr-overlay"></div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 content-head">
                <div class="mbr-section-head mb-10">
                    <h3 class="mbr-section-title mbr-fonts-style align-center mb-5 display-2"><strong >Login</strong></h3>
...
<section data-bs-version="5.1" class="contacts01 cid-ufYR7gPCbW mbr-parallax-background" id="contacts01-2u">
...
<section data-bs-version="5.1" class="footer3 cid-ufLdT4aaxz" once="footers" id="footer03-2i">
