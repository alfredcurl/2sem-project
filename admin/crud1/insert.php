...
// Code for move image into directory
		...
		// $imgnewfile = md5(uniqid($_FILES["profilepic"]["name"], true));
		// move_uploaded_file($_FILES["profilepic"]["tmp_name"], "profilepics/" . $imgnewfile . $extension);

// Query for data insertion
		$query = mysqli_query($con, "insert into tblusers1(FirstName,LastName, MobileNumber, Email, Address,ProfilePic) value('$fname','$lname', '$contno', '$email', '$add','$imgnewfile' )");
		if ($query) {
