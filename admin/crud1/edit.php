...
if (isset($_POST['submit'])) {
	...
	$query = mysqli_query($con, "update  tblusers1 set FirstName='$fname',LastName='$lname', MobileNumber='$contno', Email='$email', Address='$add' where ID='$eid'");
...
<div class="signup-form">
 ...
 <?php
$eid = $_GET['editid'];
$ret = mysqli_query($con, "select * from tblusers1 where ID='$eid'");
