<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="index.php">
        <img src="assets/img/logos/BUDGE-142a3934.webp" alt="">
        <span class="ms-1 font-weight-bold">Jovoc-Admin</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="gallery.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
             <i class="fa fa-camera text-dark text lg"></i>
            </div>
        ...
        <div class="sidenav-footer mx-3 ">
            <a href="logout.php"  class="btn btn-danger btn-sm w-100 mb-0">Logout</a>
          </div>
        </div>
      </div>
    </div>
